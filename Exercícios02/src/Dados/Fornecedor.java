...
import Abstract.Dados;
import Abstract.Implementainterface;
...
Dados d = new Dados();
	...
	@Override
	public void andar() {
		System.out.println("Fornecedor anda");
	}

	@Override
	public void comer() {
		System.out.println("Fornecedor come");
	}

	@Override
	public void correr() {
		System.out.println("Fornecedor corre");
	}

	@Override
	public void falar() {
		System.out.println("Fornecedor fala");
	}
